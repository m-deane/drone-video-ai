...
> **Template agent**: Docusaurus specialist — only relevant when your project uses Docusaurus for documentation. Will not be auto-selected for projects that don't.
